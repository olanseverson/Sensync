...
void displayValue2TFT() {
  ...
  String temp;
  temp = sensorValue[0];
  displaySensorVal("pH ", temp.toFloat());
  temp = sensorValue[1];
  displaySensorVal("DO ", temp.toFloat());
  temp = sensorValue[2];
  displaySensorVal("COND ", temp.toFloat());
  temp = sensorValue[3];
  displaySensorVal("TDS ", temp.toFloat());
  temp = sensorValue[4];
  displaySensorVal("SALT ", temp.toFloat());
  temp = sensorValue[5];
  displaySensorVal("SWSG ", temp.toFloat());
  temp = sensorValue[6];
  displaySensorVal("TEMP ", temp.toFloat());
}
